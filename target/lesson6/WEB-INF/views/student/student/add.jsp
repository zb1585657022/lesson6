        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <c:choose>
                    <c:when test="${cs.equals('add')}">
                        <li class="active">
                            <spring:message code="新增学生"/>
                        </li>
                    </c:when>
                    <c:when test="${cs.equals('edit')}">
                        <li class="active">
                            <spring:message code="修改学生信息"/>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="active">
                            <spring:message code="删除学生信息"/>
                        </li>
                    </c:otherwise>
                </c:choose>
            </ul><!-- /.breadcrumb -->
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form action="${pageContext.request.contextPath}/student/student/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                  id="admin-add-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <c:choose>
                                        <c:when test="${cs.equals('add')}">
                                            <div class="col-sm-3">
                                                <input type="hidden"  id="stuId" name="stuId" maxlength="50" value="10000000">
                                                <input readonly autocomplete="off" type="text" value="学号自动赋值" class="required form-control"/>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="col-sm-3">
                                                <input type="text" autocomplete="off" id="stuId" name="stuId" maxlength="50" value="${student.stuId}"
                                ...
                                <div class="col-sm-3">
                                    <input type="text" autocomplete="off" id="stuName" name="stuName" maxlength="50" value="${student.stuName}"
                                    ...
                                    <div class="col-sm-3">
                                        <label class="checkbox-inline">
                                            <input type="radio" name="stuSex" value="男"
                                                   <c:if test="${student.stuSex=='男'}">checked</c:if>/>&nbsp;
                                            &nbsp;<spring:message
                                                code="sex.male"/>
                                        </label>
                                        &nbsp; &nbsp; &nbsp;&nbsp;
                                        <label class="checkbox-inline">
                                            <input type="radio" name="stuSex" value="女"
                                                   <c:if test="${student.stuSex=='女'}">checked</c:if>/>&nbsp;
                                            &nbsp;<spring:message
                                                code="sex.female"/>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" autocomplete="off" id="stuBirthday" name="stuBirthday"  maxlength="50"  value="${student.stuBirthday}" class=" form-control"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select id="stuGrade" name="stuGrade">
                                            <c:if test="${cs.equals('edit')}">
                                                <option value="${student.stuGrade}">${student.stuGrade}</option>
                                            </c:if>
                                            <c:forEach items="${grades}" var="grade">
                                                <option value="${grade.graName}">${grade.graName}</option>
                                            </c:forEach>
                                        </select>
                                        <%--<input type="text" autocomplete="off" id="stuGrade" name="stuGrade" maxlength="50" value="${student.stuGrade}"
                                               class="required form-control"/>--%>
                                    </div>
                                </div>
                                <br/>
