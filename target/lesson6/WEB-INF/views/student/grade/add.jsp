        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <c:choose>
                    <c:when test="${cs.equals('add')}">
                        <li class="active">
                            <spring:message code="新增班级"/>
                        </li>
                    </c:when>
                    <c:when test="${cs.equals('edit')}">
                        <li class="active">
                            <spring:message code="修改班级信息"/>
                        </li>
                    </c:when>
                    <c:otherwise>
                        <li class="active">
                            <spring:message code="删除班级信息"/>
                        </li>
                    </c:otherwise>
                </c:choose>
            </ul><!-- /.breadcrumb -->
                            ...
                            <form action="${pageContext.request.contextPath}/student/grade/save_${cmd}.do" method="post" class="form-horizontal" role="form"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="name">
                                        <spring:message code="班级号"/>
                                    </label>
                                    <c:choose>
                                        <c:when test="${cs.equals('add')}">
                                            <div class="col-sm-3">
                                                <input type="hidden"  id="graId" name="graId" maxlength="50" value="10000000">
                                                <input readonly autocomplete="off" type="text" value="班级号自动赋值" class="required form-control"/>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
                                            <div class="col-sm-3">
                                                <input type="text" autocomplete="off" id="graId" name="graId" maxlength="50" value="${grade.graId}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" autocomplete="off" id="graName" name="graName" maxlength="50" value="${grade.graName}"
